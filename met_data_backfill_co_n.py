...
TIFpath = '/nfs/depot/cce_u1/hill/dfh/op_snowmodel/get_met_data/GEE_Downloads_co_n_backfill/'
...
def missing_slice_check(stdt, eddt, TIFpath):
    ...
    if len(timesin) != len(gee_times):
        ...
        # if 8 or more consecutive timeslices are missing - quit the function
        duration = []
